...
public class XRecyclerView extends RecyclerView {
    ...
    private BdjRefreshHeader mRefreshHeader;
    ...
    private void init(Context context) {
        if (pullRefreshEnabled) {
            BdjRefreshHeader refreshHeader = new BdjRefreshHeader(context);
    ...
    public void addHeaderView(View view) {
        if (pullRefreshEnabled && !(mHeaderViews.get(0) instanceof YunRefreshHeader)) {
            BdjRefreshHeader refreshHeader = new BdjRefreshHeader(getContext());
            mHeaderViews.put(0, refreshHeader);
            mRefreshHeader = refreshHeader;
        }
