...
public class BdjRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public BdjRefreshHeader(Context context) {
        this(context, null);
    }

    public BdjRefreshHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BdjRefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.bdj_refresh_header, this);
...
//                    animationDrawable.stop();
//                }
                mImg.setImageResource(R.drawable.list_view_pull);
...
//                    }
                    mImg.setImageResource(R.drawable.list_view_release);
                    msg.setText(R.string.listview_header_hint_release);
                }
                break;
            case STATE_REFRESHING:
                mImg.setImageResource(R.drawable.header_bdj_anim);
                AnimationDrawable ad = (AnimationDrawable)mImg.getDrawable();
                if (!ad.isRunning()){
                    ad.start();
                }
